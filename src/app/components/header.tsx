...
export default function Nav() {
  return (
    ...
    <div className="bg-[#fafafa] flex justify-between items-center px-6 py-2 md:text-[11px] sm:text-[9px] text-[8px] font-medium text-gray-500">
      <Image src={"/logo1 (1).png"} alt={''} width={24} height={24}/>
      <div>
  <p className="text-black text-sm bg-white"></p>
    ...
    <div className="flex flex-wrap justify-between items-center px-6 py-4">
      ...
      <nav className="flex gap-4 md:gap-6 text-gray-700 font-medium md:text-[16px] sm:text-[14px] text-[10px] ">
        <Link href="#" className="hover:text-black whitespace-nowrap hover:underline">New & Featured</Link>
        <Link href="#" className="hover:text-black whitespace-nowrap hover:underline">Men</Link>
        <Link href="#" className="hover:text-black whitespace-nowrap hover:underline">Women</Link>
        <Link href="#" className="hover:text-black whitespace-nowrap hover:underline">Kids</Link>
        <Link href="#" className="hover:text-black whitespace-nowrap hover:underline">Sale</Link>
        <Link href="#" className="hover:text-black whitespace-nowrap hover:underline">SNKRS</Link>
      </nav>
